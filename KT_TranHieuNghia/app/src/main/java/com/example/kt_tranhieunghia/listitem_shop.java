...
public class listitem_shop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position,
                                    long id) {
                Intent intent = new Intent(listitem_shop.this, ProductActivity.class);
    ...
    private class ItemLongClickRemove implements AdapterView.OnItemLongClickListener {
        ...
        public boolean onItemLongClick(AdapterView parent, View view, final int position, long id) {
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(listitem_shop.this);
    ...
    public void openMyCustom() {
        ...
        final View alert = LayoutInflater.from(this).inflate(R.layout.listitem2_product, null);
